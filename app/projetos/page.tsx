...
function ProjectImage({
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-[linear-gradient(135deg,#ece5db_0%,#c9b49d_45%,#8c705e_100%)]">
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.04)_0%,rgba(0,0,0,0.18)_100%)]" />
    </div>
  );
}
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {projects.map((project, index) => (
            <Reveal key={project.id} delay={index * 120}>
              <article className="group overflow-hidden rounded-[28px] border border-[#e8dece] bg-white shadow-[0_16px_38px_rgba(0,0,0,0.05)]">
                <div className="relative h-[520px] overflow-hidden">
                  <ProjectImage src={project.image} alt={project.alt} />

                  <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0.42)_100%)] opacity-90 transition duration-300 group-hover:opacity-100" />
                  ...
                  <div className="pointer-events-none absolute inset-x-5 bottom-5 rounded-[22px] border border-white/15 bg-[rgba(24,19,16,0.68)] p-5 backdrop-blur-md md:inset-x-6 md:bottom-6 md:p-6">
        ...
        <section className="mx-auto max-w-[1280px] px-6 pb-16 md:px-8 md:pb-24">
          <div className="rounded-[28px] border border-[#d9cfbf] bg-[#231d18] px-8 py-10 text-center shadow-[0_20px_60px_rgba(0,0,0,0.08)] md:px-12 md:py-14">
            ...
            <p className="mx-auto mt-4 max-w-[680px] text-sm leading-7 text-[#d8cec2] md:text-base">
              Se procura uma solução personalizada, elegante e pensada ao
              detalhe, estamos disponíveis para desenvolver um projeto à medida.
            </p>
